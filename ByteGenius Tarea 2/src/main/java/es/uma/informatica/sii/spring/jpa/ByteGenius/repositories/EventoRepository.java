...
import es.uma.informatica.sii.spring.jpa.ByteGenius.entities.Tipo;
...
public interface EventoRepository extends JpaRepository<Evento, Integer>{
   ...
   List<Evento> findByNameAndDescripcionAndLugar(@Param("nombre") String nombre, @Param("descripcion") String descripcion, @Param("lugar") String lugar);
